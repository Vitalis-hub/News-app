...
urlpatterns = [
    ...
    url(r'^panel/manager/addperm/(?P<pk>\d+)/(?P<name>.*)/$', views.users_perms_add, name='users_perms_add'),
    url(r'^panel/manager/addpermtogroup/(?P<name>.*)/$', views.groups_perms, name='groups_perms'),
    url(r'^panel/manager/delperms/(?P<gname>.*)/(?P<name>.*)/$', views.groups_perms_del, name='groups_perms_del'),
    url(r'^panel/manager/addperms/(?P<name>.*)/$', views.groups_perms_add, name='groups_perms_add'),
